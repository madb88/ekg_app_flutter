...
import 'third_nested_six_component_view_controller.dart';
...
class ThirdNestedSixComponentCardList extends StatelessWidget {
  final category;
  final categoryName;

  ThirdNestedSixComponentCardList(
      this.category,
      this.categoryName
      );
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                     MyCustomRoute(
                                        builder: (context) =>
                                            ThirdNestedSixComponentViewController(
                                                index, sendedCard)),
                                  );
                                },
                                trailing: Icon(
