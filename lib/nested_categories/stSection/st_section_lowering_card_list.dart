...
import 'st_section_lowering_view_controller.dart';
...
class StSectionLoweringCardList extends StatelessWidget {
  final category;
  final categoryName;
  StSectionLoweringCardList(this.category, this.categoryName);
                            ...
                            new ListTile(
                              onTap: () {
                                ...
                                Navigator.push(
                                  ...
                                  new MyCustomRoute(
                                      builder: (context) =>
                                          StSectionLoweringViewController(index, sendedCard)),
                                );
                              },
