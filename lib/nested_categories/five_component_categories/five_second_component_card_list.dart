...
class FiveSecondComponentCardList extends StatelessWidget {
  final category;
  FiveSecondComponentCardList(this.category);

  final categoryNames = {
    'first':'Blok przedsionkowo-komorowy',
  };
    ...
    return new Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        Container(
          ...
          child: CategoryButtonColor(SecondNestedComponentCardList(categoryNames['first'],'second_nested_five_component_cards'), categoryNames['first'],Colors.orange[400]),
            ...
            new Flexible(
              child: FutureBuilder(
                future: DefaultAssetBundle
                    .of(context)
                    .loadString('data_repo/five_second_component_cards.json'),
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                    context,
                                     MyCustomRoute(
                                        builder: (context) =>
                                            FiveSecondComponentViewController(
                                                index, sendedCard)),
                                  );
                                },
                                trailing: Icon(
