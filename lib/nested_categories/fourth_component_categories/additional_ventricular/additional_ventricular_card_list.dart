...
import 'dart:convert';
import 'additional_ventricular _view_controller.dart';
import 'package:ekg_cards_app/customRoute.dart';

class AdditionalVentricularCardList extends StatelessWidget {
  final category;
  final categoryName;

  AdditionalVentricularCardList(
      this.category,
      this.categoryName
      );
                            ...
                            new ListTile(
                              onTap: () {
                                ...
                                Navigator.push(
                                  ...
                                  new MyCustomRoute(
                                      builder: (context) =>
                                          AdditionalVentricularViewController(index, sendedCard)),
                                );
                              },
